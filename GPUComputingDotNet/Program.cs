...
namespace GPUComputing
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Kernel kernel = Binding.clCreateKernel(program, "vector_sum", out kernelError);
            ...
            Event ignoore;
            ErrorCode errorWrite1 = Binding.clEnqueueWriteBuffer(queue, mem1, CLBool.CL_TRUE, 0, memorySize, ptrMem1, 0, IntPtr.Zero, out ignoore);
            ...
            Event ignoore2;
            ErrorCode errorWrite2 = Binding.clEnqueueWriteBuffer(queue, mem2, CLBool.CL_TRUE, 0, memorySize, ptrMem2, 0, IntPtr.Zero, out ignoore2);
            ...
            ErrorCode errorND = Binding.clEnqueueNDRangeKernel(queue, kernel, 1, 0, new nint[] {5}, null, 0, IntPtr.Zero, out _);

            IntPtr resultF = Marshal.AllocHGlobal(memorySize);
            ErrorCode errorRead = Binding.clEnqueueReadBuffer(queue, memRes, CLBool.CL_TRUE, 0, memorySize, resultF, 0, IntPtr.Zero, out _);
